...
{
    [TestFixture]
    class When_replacing_a_component : _on_a_dynamic_cluster_of<Queue>
    {
        [Test]
        public void A_write_lock_is_obtained()
        {
            Sut.Replace(Components[Primary].Object, Mock.Of<IFailable<Queue>>());
        ...
        {
            Action replacing = () => Sut.Replace(Components[Primary].Object, Mock.Of<IFailable<Queue>>());
